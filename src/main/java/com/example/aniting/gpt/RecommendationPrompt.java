...
public class RecommendationPrompt {
    ...
    public static String buildPrompt(Map<String, String> responses) {
        ...
        return "당신은 반려동물 추천 전문가입니다. 아래는 사용자 성향에 대한 6가지 점수입니다.\n" +
                ...
                "1. 개와 고양이처럼 흔한 반려동물 외에도 **이국적이거나 특이한 동물**도 되도록이면 포함되도록 하세요.\n" +
                "2. 희귀 품종 또는 특이한 성격의 종(예: 슈가 글라이더, 코뉴어 앵무새, 고슴도치, 핀란드 스피츠, 맨체스터 테리어 등)도 고려하세요.\n" +
                "3. 단, 실제로 일반인이 실내에서 기를 수 있고, 인간과 정서적 교감을 나눌 수 있는 동물로 제한합니다.\n" +
                "4. 각 추천 동물은 사용자의 성향 점수와 연결하여 구체적인 이유를 작성해주세요.\n\n" +
